    ...
    public class InitialTables_202311060001 : Migration
    {
        ...
        public override void Up()
        {
            Create.Table("Users")
                ...
                .WithColumn("GraduatedFromUniversity").AsString(50).Nullable()
                .WithColumn("GraduatedFromCollege").AsString(50).Nullable()
                .WithColumn("GraduatedFromDepartment").AsString(50).Nullable()
                .WithColumn("GraduatedYear").AsString(12).Nullable()
                .WithColumn("StudyingYearsCount").AsInt32().Nullable()
                .WithColumn("JobType").AsString(50).Nullable()
                .WithColumn("JobSector").AsString(50).Nullable()
                .WithColumn("JobTitle").AsString(50).Nullable()
                .WithColumn("JobDegree").AsInt32().Nullable()
                .WithColumn("RecruitmentYear").AsDateTime2().Nullable()
                .WithColumn("JobPlace").AsString(150).Nullable()
